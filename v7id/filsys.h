...
struct	filsys
{
	...
	int	s_nfree;	/* number of in core free blocks (0-50) */	/***/
	int	s_free[50];	/* in core free blocks */	/***/
	int	s_ninode;	/* number of in core I nodes (0-50) */	/***/
	int	s_inode[50];	/* in core free I nodes */	/***/
