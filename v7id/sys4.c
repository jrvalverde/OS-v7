...
getswit()
{
	...
	u.u_ar0[R0] = csw;	/* console switches read by display() */
}
 ...
 * This call had been withdrawn because it messes up
...
ssig()
{
	 ...
	 *   pop PS, PC, and SP off stack.
	 */
/***/	if (a == 0) {
/***/		asp = u.u_ar0[RSP];
/***/		if ((aps = fuword(asp++)) & (1<<31))	/* no user stack */
/***/			u.u_nostack = 1;
/***/		u.u_ar0[RPS] = (aps & 010017) | (u.u_ar0[RPS] & ~010017);
/***/		u.u_ar0[RPC] = fuword(asp++);
/***/		u.u_ar0[RSP] = fuword(asp);
/***/		return;
/***/	}
...
profil()
{
	...
	u.u_prof[0] =u.u_arg[0] & ~3;	/* base of sample buf */
	u.u_prof[1] = u.u_arg[1] & ~3;	/* size of same */
	u.u_prof[2] = u.u_arg[2];	/* pc offset*/
	u.u_prof[3] = (u.u_arg[3]>>1); /* pc scale *//***/
}
