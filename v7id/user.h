 ...
 *** The user block is USIZE*256 bytes
 * long; resides at virtual kernel
 *** loc x'e0000'; contains the system
...
extern struct user
{
	...
	int	u_tsize;		/*** text size (*256) ***/
	int	u_dsize;		/*** data size (*256) ***/
	int	u_ssize;		/*** stack size (*256) ***/
...
/***/	char	u_nostack;		/* Process has no user stack */
